...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1313: x0 => x0.click(),
      _1314: x0 => x0.remove(),
      _1324: () => new AudioContext(),
      _1325: (x0,x1) => x0.createMediaElementSource(x1),
      _1326: x0 => x0.createGain(),
      _1327: x0 => x0.createStereoPanner(),
      _1328: (x0,x1) => x0.connect(x1),
      _1329: x0 => x0.load(),
      _1330: x0 => x0.disconnect(),
      _1331: x0 => x0.resume(),
      _1332: x0 => x0.play(),
      _1333: x0 => x0.pause(),
      _1334: x0 => x0.close(),
      ...
      _1338: (x0,x1) => x0.querySelector(x1),
      _1339: (x0,x1) => x0.item(x1),
      _1340: () => new FileReader(),
      _1342: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1349: (x0,x1) => x0.removeChild(x1),
      _1351: (x0,x1) => x0.appendChild(x1),
      _1352: (x0,x1) => x0.querySelector(x1),
      _1353: Date.now,
      ...
      _1357: () => new Error().stack,
      _1358: () => typeof dartUseDateNowForTicks !== "undefined",
      _1359: () => 1000 * performance.now(),
      _1360: () => Date.now(),
      _1361: () => {
      ...
      _1363: () => new WeakMap(),
      _1364: (map, o) => map.get(o),
      _1365: (map, o, v) => map.set(o, v),
      _1366: (exn) => exn.toString(),
      _1367: (exn) => exn.stack,
      _1368: (exn) => {
      ...
      _1383: (o, p, r) => o.replaceAll(p, () => r),
      _1384: (o, p, r) => o.replace(p, () => r),
      _1385: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1386: s => s.toUpperCase(),
      _1387: s => s.trim(),
      _1388: s => s.trimLeft(),
      _1389: s => s.trimRight(),
      _1390: (string, times) => string.repeat(times),
      _1391: Function.prototype.call.bind(String.prototype.indexOf),
      _1392: (s, p, i) => s.lastIndexOf(p, i),
      _1393: (string, token) => string.split(token),
      _1394: Object.is,
      _1398: (o, c) => o instanceof c,
      _1399: o => Object.keys(o),
      _1402: (o, a) => o + a,
      _1429: x0 => new Array(x0),
      _1431: x0 => x0.length,
      _1433: (x0,x1) => x0[x1],
      _1434: (x0,x1,x2) => { x0[x1] = x2 },
      _1437: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1439: x0 => new Int8Array(x0),
      _1440: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1442: x0 => new Uint8ClampedArray(x0),
      _1444: x0 => new Int16Array(x0),
      _1446: x0 => new Uint16Array(x0),
      _1448: x0 => new Int32Array(x0),
      _1450: x0 => new Uint32Array(x0),
      _1452: x0 => new Float32Array(x0),
      _1454: x0 => new Float64Array(x0),
      _1478: x0 => x0.random(),
      _1479: (x0,x1) => x0.getRandomValues(x1),
      _1480: () => globalThis.crypto,
      _1481: () => globalThis.Math,
      _1494: (ms, c) =>
      ...
      _1588: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1588(f,arguments.length,x0,x1,x2) }),
      _1589: (x0,x1) => x0.forEach(x1),
      _1590: x0 => x0.getReader(),
      _1591: x0 => x0.cancel(),
      _1592: x0 => x0.read(),
      _1593: (x0,x1) => x0.key(x1),
      _1594: o => o instanceof Array,
      _1599: a => a.pop(),
      ...
      _1611: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1613: o => o instanceof Uint8Array,
      _1614: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1615: o => o instanceof Int8Array,
      _1616: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1617: o => o instanceof Uint8ClampedArray,
      _1618: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1619: o => o instanceof Uint16Array,
      _1620: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1621: o => o instanceof Int16Array,
      _1622: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1623: o => o instanceof Uint32Array,
      _1624: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1625: o => o instanceof Int32Array,
      _1626: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1628: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1629: o => o instanceof Float32Array,
      _1630: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1631: o => o instanceof Float64Array,
      _1632: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1633: (t, s) => t.set(s),
      _1634: l => new DataView(new ArrayBuffer(l)),
      _1635: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1637: o => o.buffer,
      _1638: o => o.byteOffset,
      _1639: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1640: (b, o) => new DataView(b, o),
      _1641: (b, o, l) => new DataView(b, o, l),
      _1642: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1643: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1644: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1645: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1646: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1647: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1648: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1649: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1650: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1651: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1652: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1653: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1656: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1657: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1658: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1659: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1660: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1661: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1662: Function.prototype.call.bind(Number.prototype.toString),
      _1663: Function.prototype.call.bind(BigInt.prototype.toString),
      _1664: Function.prototype.call.bind(Number.prototype.toString),
      _1665: (d, digits) => d.toFixed(digits),
      _1832: (x0,x1) => { x0.draggable = x1 },
      _1848: x0 => x0.style,
      _2451: x0 => x0.error,
      _2453: (x0,x1) => { x0.src = x1 },
      _2458: (x0,x1) => { x0.crossOrigin = x1 },
      _2461: (x0,x1) => { x0.preload = x1 },
      _2465: x0 => x0.currentTime,
      _2466: (x0,x1) => { x0.currentTime = x1 },
      _2467: x0 => x0.duration,
      _2472: (x0,x1) => { x0.playbackRate = x1 },
      _2481: (x0,x1) => { x0.loop = x1 },
      _2502: x0 => x0.code,
      _2503: x0 => x0.message,
      _2774: (x0,x1) => { x0.accept = x1 },
      _2788: x0 => x0.files,
      _2814: (x0,x1) => { x0.multiple = x1 },
      _2832: (x0,x1) => { x0.type = x1 },
      _3082: (x0,x1) => { x0.src = x1 },
      _3084: (x0,x1) => { x0.type = x1 },
      _3088: (x0,x1) => { x0.async = x1 },
      _3102: (x0,x1) => { x0.charset = x1 },
      _3551: () => globalThis.window,
      _3591: x0 => x0.document,
      _3613: x0 => x0.navigator,
      _3877: x0 => x0.localStorage,
      _4000: x0 => x0.userAgent,
      _4208: x0 => x0.length,
      _5595: x0 => x0.destination,
      _5599: x0 => x0.state,
      _5690: (x0,x1) => { x0.value = x1 },
      _5839: x0 => x0.gain,
      _6148: x0 => x0.signal,
      _6203: x0 => x0.baseURI,
      _6209: x0 => x0.firstChild,
      _6220: () => globalThis.document,
      _6304: x0 => x0.head,
      _6633: x0 => x0.id,
      _6634: (x0,x1) => { x0.id = x1 },
      _6661: x0 => x0.children,
      _7980: x0 => x0.value,
      _7982: x0 => x0.done,
      _8162: x0 => x0.size,
      _8169: x0 => x0.name,
      ...
      _8677: x0 => x0.url,
      _8679: x0 => x0.status,
      _8681: x0 => x0.statusText,
      _8682: x0 => x0.headers,
      _8683: x0 => x0.body,
      _11089: (x0,x1) => { x0.display = x1 },
      _12311: x0 => x0.name,
      _13059: x0 => globalThis.Wakelock.toggle(x0),
