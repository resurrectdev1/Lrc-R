...
class _LrcHomeScreenState extends State<LrcHomeScreen>
  ...
  void didChangeDependencies() {
    ...
    final isComplete =
        session.totalLines > 0 && session.tagIndex >= session.totalLines;
      ...
      if (restore == true) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            _snack('Session restored — please re-load the audio file'),
          );
        }
      } else {
  ...
  Future<void> _copyToClipboard(LrcSession session) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(_snack('LRC copied to clipboard ✓'));
    }
  }
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                'Choose how you\'d like to export your synced lyrics',
                style: TextStyle(fontSize: 13, color: theme.textSecondary),
              ),
              const SizedBox(height: 20),
              _ExportOptionTile(
              ...
              _ActionIconButton(
                ...
                onTap: () => showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    content: Text(
                      'All tagged timestamps will be cleared.',
                      style: TextStyle(color: theme.textSecondary),
                    ),
                    actions: [
                      TextButton(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'One lyric line per line. Blank lines are ignored.',
                      style: TextStyle(
                        fontSize: 13,
                        color: theme.textSecondary,
                      ),
